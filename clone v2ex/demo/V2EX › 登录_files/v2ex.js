...
function protectTraffic() {
	...
	if ((l.indexOf("v2ex.com") == -1) && (l.indexOf("v2work.com") == -1) && (l.indexOf("127.0.0.1:") == -1) && (l.indexOf("localhost:") == -1) && (l.indexOf("192.168") == -1) && (l.indexOf("10.0.1.") == -1) && (l.indexOf("10.1.10.") == -1) && (l.indexOf("108.") == -1)) {
